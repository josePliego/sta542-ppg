...
mae_tab = array2table(mae_vec);
mae_tab.Properties.VariableNames(:) = names;
writetable(mae_tab,'../../data/mae_reconstruction_two_harmonics.csv');

signal_tab = array2table(recon_mat);
signal_tab.Properties.VariableNames(:) = names;
writetable(signal_tab,'../../data/signal_reconstruction_two_harmonics.csv');
...
mae_tab = array2table(mae_vec);
mae_tab.Properties.VariableNames(:) = names;
writetable(mae_tab,'../../data/mae_reconstruction_three_harmonics.csv');

signal_tab = array2table(recon_mat);
signal_tab.Properties.VariableNames(:) = names;
writetable(signal_tab,'../../data/signal_reconstruction_three_harmonics.csv');
