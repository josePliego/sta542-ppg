...
files = dir('../../data/0*INTERPOLATED.mat');
...
for i = 1:length(files)
    ...
    [recon, mae] = get_mae(ppg, co2, Hz, NoWindowsInConceFT, NoConceFT, ...
...
writetable(mae_tab,'../../data/mae_reconstruction_interpolated.csv');

signal_tab = array2table(recon_mat);
signal_tab.Properties.VariableNames(:) = names;
writetable(signal_tab,'../../data/signal_reconstruction_interpolated.csv');